...
// transform: translateY(-20px) (classe tech)
...
function dbclRedirect() {
  window.location.href = 'https://github.com/nnnnadia'
}
myWebpage.addEventListener('dblclick', dbclRedirect);
